...
{
    return GetBoolArg("-testnet", false) ? 25253 : 25251;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop GCOIN server (and possibly override the detachdb config value).");
