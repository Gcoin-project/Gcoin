...
unsigned int nTargetSpacing = 1 * 81; // 81 seconds
...
static const int64_t nTargetTimespan = 15 * 81;  // 15 blocks
//
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Tue, 07 Oct 2014 18:04:37 GMT";
        CTransaction txNew;
        txNew.nTime = 1412705077;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x580c6f8115070e119524e29876dce70c9b50aca79ff7191076befc0df035aaad"));
        block.print();
